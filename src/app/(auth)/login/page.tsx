      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#12121a] border border-[#1e1e2e] rounded-2xl p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-[#2e2e45] text-white hover:bg-[#1e1e2e] transition-colors mb-4"
          >
          ...
          <div className="space-y-4">
            ...
            <input type="password" placeholder="••••••••" className="w-full h-11 px-4 rounded-xl border border-[#2e2e45] bg-[#0a0a0f] text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 transition-colors" />
            <button className="w-full h-11 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 text-white font-semibold hover:opacity-90 transition-opacity">Sign In</button>
          </div>
